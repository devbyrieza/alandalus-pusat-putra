        ...
        <div className="space-y-6">
            ...
            {conflicts.length > 0 && (
                <motion.div 
                    ...
                    className="bg-rose-50 border border-rose-200 rounded-xl p-5 flex items-start gap-4 shadow-lg shadow-emerald-900/20 shadow-rose-100"
                >
                    <div className="w-10 h-10 bg-rose-100 rounded-xl flex items-center justify-center text-rose-600 shrink-0 whitespace-nowrap inline-block shrink-0">
                ...
                <div className="flex flex-col md:flex-row gap-3">
                    ...
                    <div className="flex-1 flex gap-2">
                        <div className="relative flex-1">
                            ...
                            <input 
                                ...
                                className="w-full bg-white border border-slate-200 rounded-xl pl-10 pr-4 py-2 text-sm focus:ring-4 focus:ring-primary-500/5 focus:border-primary-500 outline-none font-bold h-12 transition-all shadow-lg shadow-emerald-900/20"
                            />
                        </div>
                        <select 
                            value={filterJenjang}
                            onChange={(e) => setFilterJenjang(e.target.value)}
                            className="w-32 bg-white border border-slate-200 rounded-xl px-3 py-2 text-[11px] font-black text-ink-600 focus:ring-4 focus:ring-primary-500/5 focus:border-primary-500 outline-none h-12 shadow-lg shadow-emerald-900/20 appearance-none text-center uppercase tracking-wider"
                        >
                    ...
                    <div className="flex items-center gap-2">
                        <div className="flex-1 md:flex-none flex bg-slate-100 p-1.5 rounded-xl h-12 min-w-fit whitespace-nowrap inline-block shrink-0">
                            {[
                                ...
                                <button 
                                    ...
                                    className={`px-5 rounded-xl text-[11px] font-bold uppercase tracking-wider transition-all ${viewMode === mode.id ? "bg-white text-primary-700 shadow-lg shadow-emerald-900/20" : "text-slate-400 hover:text-slate-600"}`}
                                >
                                    {mode.label}
                                </button>
                            ))}
                        ...
                        <button 
                            ...
                            className="w-12 h-12 bg-white border border-slate-200 hover:bg-slate-50 text-slate-700 rounded-xl shadow-lg shadow-emerald-900/20 transition-all flex items-center justify-center shrink-0"
                            title="Refresh Data"
                        >
                        ...
                        <button 
                            ...
                            className={`px-4 rounded-xl text-[11px] font-bold uppercase tracking-wider transition-all border h-12 shadow-lg shadow-emerald-900/20 ${
                                showPast 
                        ...
                        {getGroupedBySantri().map((group) => (
                            <div key={group.name} className="bg-white rounded-[2rem] shadow-clay-m border border-slate-100 overflow-hidden flex flex-col transition-all hover:translate-y-[-4px] group">
                                <div className="bg-slate-50 px-6 py-6 border-b border-slate-100 group-hover:bg-primary-50/50 transition-colors">
                                    <div className="flex items-center gap-4">
                                        <div className="w-12 h-12 bg-white rounded-xl flex items-center justify-center shadow-lg shadow-emerald-900/20 border border-slate-100">
