    ...
    <main className="bg-slate-50 min-h-screen py-16">
      <Container>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto mb-16">
          {/* ADDRESS */}
          <div className="bg-white p-8 rounded-xl border border-slate-200 shadow-lg shadow-emerald-900/20 text-center space-y-4 hover:shadow-md transition-shadow">
            <div className="w-14 h-14 rounded-xl bg-emerald-500/10 text-emerald-600 flex items-center justify-center mx-auto font-bold">
          ...
          {/* EMAIL */}
          <div className="bg-white p-8 rounded-xl border border-slate-200 shadow-lg shadow-emerald-900/20 text-center space-y-4 hover:shadow-md transition-shadow">
            <div className="w-14 h-14 rounded-xl bg-sky-500/10 text-sky-600 flex items-center justify-center mx-auto font-bold">
        ...
        {/* SOCIAL MEDIA & ACTION */}
        <div className="bg-white p-8 md:p-12 rounded-xl border border-slate-200 shadow-lg shadow-emerald-900/20 max-w-4xl mx-auto text-center space-y-8">
          ...
          <div className="pt-4 border-t border-slate-100 flex flex-wrap justify-center gap-4">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center gap-2 px-8 py-4 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white font-bold shadow-lg transition-all"
            >
