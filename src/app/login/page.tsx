...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-[#F0FDF4] via-[#F8FAFC] to-white flex flex-col items-center justify-center p-4 sm:p-6 py-10 sm:py-16 relative overflow-hidden font-sans">
      ...
      <div className="w-full max-w-5xl lg:max-w-6xl flex items-center justify-between gap-3 mb-4 z-10">
        <Link
          href="/"
          className="inline-flex items-center gap-2 px-4 py-2.5 rounded-2xl bg-white/95 border border-slate-200/90 shadow-2xs text-xs font-extrabold uppercase tracking-wider text-slate-700 hover:text-[#064e3b] hover:border-[#064e3b]/40 transition-all hover:-translate-y-0.5"
        >
        ...
        <div className="inline-flex items-center gap-2 px-4 py-2.5 rounded-2xl bg-white/95 border border-slate-200/90 shadow-2xs text-xs font-bold text-slate-700">
          ...
          <span>Portal Resmi PPDB Putra 2027</span>
        </div>
      </div>

      {/* TWO-PANEL OMI LOGIN CARD (DESKTOP SPLIT / MOBILE STACKED) */}
      <div className="w-full max-w-5xl lg:max-w-6xl rounded-3xl overflow-hidden shadow-2xl shadow-emerald-950/10 border border-slate-200 bg-white grid grid-cols-1 lg:grid-cols-12 relative z-10">
        
        {/* SISI KIRI: PANEL IDENTITAS & 2 BENTO UNGGULAN (DESKTOP: 5 COLUMNS) */}
        <div className="hidden lg:flex lg:col-span-5 bg-gradient-to-br from-[#022c22] via-[#064e3b] to-[#065f46] p-6 sm:p-8 lg:p-10 text-white relative overflow-hidden flex flex-col justify-between">
          ...
          <div className="relative z-10 space-y-6">
            <div className="inline-flex items-center gap-3 bg-white px-3.5 py-2 rounded-2xl shadow-sm">
              ...
              <span className="text-xs font-extrabold text-slate-900 tracking-tight">
                {BRANDING.schoolShortName} Putra
              </span>
            </div>
            ...
            <div>
              <span className="text-[10px] font-extrabold uppercase tracking-widest text-amber-300 bg-white/10 px-3 py-1 rounded-full border border-white/15 inline-block mb-3">
                Penerimaan Santri Baru Putra {BRANDING.academicYear}
              </span>
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-white tracking-tight leading-snug">
                Pesantren Islam Internasional Al-Andalus Putra
              </h2>
              <p className="text-xs sm:text-sm text-emerald-100/90 font-normal mt-2 leading-relaxed">
                Pusat kaderisasi da'i dan generasi Robbani berakhlak mulia dengan keunggulan tahfidz Al-Qur'an 30 juz dan kepemimpinan islami.
              </p>
            </div>
              ...
              <div className="bg-white/10 backdrop-blur-md rounded-2xl p-4 border border-white/15 flex items-center gap-3.5 shadow-sm">
                ...
                <div>
                  <h4 className="text-xs sm:text-sm font-extrabold text-white">
                    Kaderisasi Generasi Robbani
                  </h4>
                  <p className="text-[11px] text-emerald-100 font-normal">
                    Pribadi kuat, cendekia &amp; berakhlak mulia
                  </p>
                </div>
              </div>

              <div className="bg-white/10 backdrop-blur-md rounded-2xl p-4 border border-white/15 flex items-center gap-3.5 shadow-sm">
                <div className="w-11 h-11 rounded-xl bg-emerald-400/20 border border-emerald-400/30 flex items-center justify-center shrink-0 text-emerald-300">
                  <ShieldCheck className="w-5 h-5" />
                </div>
                <div>
                  <h4 className="text-xs sm:text-sm font-extrabold text-white">
                    Tahfidz 30 Juz &amp; Kitab Turots
                  </h4>
                  <p className="text-[11px] text-emerald-100 font-normal">
                    Bermanhaj Ahlus Sunnah Wal Jama'ah
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="relative z-10 pt-6 mt-6 border-t border-white/10 text-[11px] text-emerald-200/80 font-medium flex items-center justify-between">
            <span>Panitia PPDB Putra &bull; Al-Andalus IIBS</span>
            <span className="text-amber-300">&bull; Kampus Putra</span>
          </div>
        </div>
        ...
        <div className="lg:col-span-7 p-6 sm:p-8 lg:p-10 bg-white space-y-6 flex flex-col justify-center">
          ...
          <div className="p-3 bg-emerald-50/70 border border-emerald-100 rounded-2xl flex items-center justify-between gap-3 text-xs">
            <span className="text-emerald-900 font-medium">Belum memiliki akun pendaftar?</span>
            <Link href="/daftar" className="font-extrabold text-[#064e3b] hover:underline flex items-center gap-1 shrink-0">
          ...
          {!roleSelectionData && (
            <div className="bg-slate-100 p-2 rounded-[2rem] flex relative mb-12 border border-slate-200 whitespace-nowrap inline-block shrink-0">
              ...
              <motion.div
                ...
                className={`absolute top-2 bottom-2 rounded-xl bg-white shadow-lg shadow-emerald-900/20 border border-slate-200/50 ${
                  activeTab === "pendaftar"
                    ...
                    {roleSelectionData.available_roles.map((role) => {
                      ...
                      return (
                        <motion.button
                          ...
                          className={`w-full p-4 rounded-xl bg-linear-to-r ${info.color} border text-left flex items-center gap-4 transition-all hover:shadow-md disabled:opacity-60`}
                        >
                          <div className="w-10 h-10 rounded-xl bg-white flex items-center justify-center text-primary-700 font-bold shadow-lg shadow-emerald-900/20 shrink-0">
      ...
      <div className="text-center text-xs text-slate-400 mt-6 font-medium space-y-1">
        ...
        <p className="text-[11px] text-slate-400/80">Panitia PPDB Al-Andalus Putra v2.0</p>
      </div>
    </main>
  );
}
