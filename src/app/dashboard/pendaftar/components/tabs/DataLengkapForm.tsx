  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3">
        {isCompleted && (
          <span className="px-3 py-1 bg-emerald-50 text-emerald-600 border border-emerald-100 text-xs font-bold rounded-xl uppercase tracking-wide whitespace-nowrap inline-block shrink-0">
            Lengkap
          </span>
        )}
        <div
      ...
      {isEditMode ? (
        <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-5 shadow-sm">
          <div className="flex items-start gap-4">
            <div className="w-10 h-10 bg-emerald-100 rounded-xl flex items-center justify-center shrink-0 whitespace-nowrap shrink-0">
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <div className="mt-4 flex flex-wrap gap-3">
                <a
                  href="https://wa.me/6283811515951?text=Bismillah,%20saya%20ingin%20mengajukan%20perubahan%20data%20pendaftaran%20untuk%20nomor%20pendaftaran:%20"
                  target="_blank"
