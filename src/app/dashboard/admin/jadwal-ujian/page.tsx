  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      <div className="bg-white rounded-xl shadow-clay-lg p-5 md:p-8 border border-white/40 overflow-hidden relative">
        ...
        <div className="relative flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="flex items-center gap-6">
            <div className="p-4 bg-gradient-to-br from-purple-500 to-indigo-600 rounded-xl shadow-lg shadow-purple-500/20">
          ...
          <div className="flex flex-col md:flex-row gap-3">
            ...
            <button
              ...
              className="flex items-center gap-3 px-6 py-3 bg-purple-600 hover:bg-purple-700 text-white rounded-xl font-black shadow-lg shadow-purple-600/20 transition-all hover:-translate-y-0.5"
            >
      ...
      <div className="grid grid-cols-1 md:grid-cols-1 sm:grid-cols-2 gap-6">
        <div className="bg-gradient-to-br from-indigo-600 to-purple-700 rounded-xl p-6 text-white shadow-lg overflow-hidden relative">
          ...
          <div className="grid grid-cols-1 gap-4">
            {loading ? (
              ...
              sessions.map((s) => (
                <div
                  key={s.id}
                  className={`group bg-white rounded-xl shadow-clay-md border border-white/40 p-6 flex flex-col md:flex-row md:items-center justify-between gap-4 transition-all ${selectedPendaftarId ? "ring-2 ring-purple-100 hover:ring-purple-200" : ""}`}
                >
                  <div className="flex items-start gap-5">
                    <div className="w-14 h-14 rounded-xl bg-purple-50 flex items-center justify-center text-purple-600 shadow-inner">
                    ...
                    {selectedPendaftarId ? (
                      ...
                      <div className="flex flex-col gap-3 w-full md:w-64 items-end">
                        ...
                        <button
                          ...
                          disabled={assigning}
                          className="text-xs font-bold text-purple-600 hover:text-purple-800 hover:bg-purple-50 px-3 py-1.5 rounded-xl transition-all flex items-center gap-2"
                        >
          ...
          <div className="bg-white rounded-xl w-full max-w-lg shadow-clay-lg border border-white overflow-hidden animate-in zoom-in-95 duration-300">
            <form onSubmit={handleCreateSession}>
              ...
              <div className="px-5 md:px-8 pb-8 flex gap-3">
                ...
                <button
                  type="submit"
                  className="flex-[2] py-4 bg-purple-600 hover:bg-purple-700 text-white rounded-xl font-black shadow-lg shadow-purple-600/20 transition-all"
                >
                  Simpan Sesi
                </button>
              </div>
