...
export default function RekapSeragamPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-lg shadow-emerald-900/20 border border-ink-100 flex flex-col min-h-[500px]">
        {/* Toolbar */}
        <div className="p-6 border-b border-ink-100 flex flex-col md:flex-row gap-4 justify-between items-center bg-ink-50/50 rounded-t-3xl">
          <div className="relative w-full md:w-80">
            ...
            <input
              ...
              className="w-full pl-11 pr-4 py-3 bg-white border border-ink-200 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 outline-none text-sm font-medium transition-all shadow-lg shadow-emerald-900/20"
            />
          </div>

          <div className="flex flex-wrap gap-3 w-full md:w-auto items-center">
            <div className="flex items-center gap-2 px-4 py-3 bg-white rounded-xl border border-ink-200 shadow-lg shadow-emerald-900/20 md:mr-2">
              <input 
                type="checkbox" 
                id="showAll" 
                checked={showAll}
            ...
            <button
              onClick={exportExcel}
              className="flex-1 md:flex-none flex items-center justify-center gap-2 px-5 py-3 bg-white border border-ink-200 text-ink-700 rounded-xl text-sm font-black hover:bg-ink-50 shadow-lg shadow-emerald-900/20 transition-all"
            >
            ...
            <button
              onClick={exportPDF}
              className="flex-1 md:flex-none flex items-center justify-center gap-2 px-5 py-3 bg-white border border-red-200 text-red-700 rounded-xl text-sm font-black hover:bg-red-50 shadow-lg shadow-emerald-900/20 transition-all"
            >
                  ...
                  filteredData.map((item, idx) => {
                    ...
                    return (
                      <tr key={item.id} className="hover:bg-ink-50/50 transition-colors">
                        ...
                        <td className="px-6 py-4 text-center">
                          {item.ukuran_seragam_celana ? (
                            <span className="inline-flex items-center justify-center w-8 h-8 rounded-xl bg-emerald-50 text-emerald-700 font-black text-xs border border-emerald-100">
                              {item.ukuran_seragam_celana}
                            </span>
                          ) : (
                            <span className="text-ink-300">-</span>
                        ...
                        <td className="px-6 py-4 text-center">
                          {item.ukuran_seragam_almamater ? (
                            <span className="inline-flex items-center justify-center w-8 h-8 rounded-xl bg-purple-50 text-purple-700 font-black text-xs border border-purple-100">
                              {item.ukuran_seragam_almamater}
                            </span>
                          ) : (
                            <span className="text-ink-300">-</span>
                        ...
                        <td className="px-6 py-4 text-center">
                          <button
                            ...
                            className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-white hover:bg-primary-50 border border-ink-200 hover:border-primary-200 text-ink-700 hover:text-primary-700 rounded-xl text-xs font-black transition-all shadow-lg shadow-emerald-900/20"
                          >
