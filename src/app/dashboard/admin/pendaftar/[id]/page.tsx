                        ...
                        <div className="flex flex-col items-end gap-2">
                          ...
                          {(!payment.bukti_transfer_path || payment.status_pembayaran !== "verified") && (
                            <button
                              ...
                              className="px-3 py-1 bg-white hover:bg-amber-100 text-amber-700 rounded-xl text-[10px] font-black uppercase tracking-wider transition-all flex items-center gap-1.5 border border-amber-200 disabled:opacity-50 whitespace-nowrap shrink-0"
                            >
