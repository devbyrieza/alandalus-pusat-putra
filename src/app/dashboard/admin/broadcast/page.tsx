    ...
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      <div className="bg-white rounded-xl shadow-clay-lg p-5 md:p-8 border border-white/40 overflow-hidden relative">
        ...
        <div className="relative flex items-center gap-6">
          <div className="p-4 bg-gradient-to-br from-primary-600 to-emerald-600 rounded-xl shadow-lg shadow-primary-600/20">
        ...
        <div className="lg:col-span-5 space-y-6">
          <div className="bg-white rounded-xl shadow-clay-md border border-white/40 p-6 space-y-6 sticky top-28">
            ...
            <div className="bg-secondary-50 rounded-xl p-4 border border-ink-100">
              ...
              <div className="bg-white rounded-xl p-4 shadow-lg shadow-emerald-900/20 text-sm whitespace-pre-wrap font-medium text-ink-800 leading-relaxed border border-white/80">
            ...
            <button
              ...
              className="w-full py-4 bg-gradient-to-br from-primary-600 to-emerald-600 text-white rounded-xl font-black shadow-lg shadow-primary-600/20 hover:shadow-primary-600/30 transition-all flex items-center justify-center gap-3 disabled:opacity-50 disabled:shadow-none"
            >
              {sending ? (
                <>
