// src/components/home/HeroSection.tsx — andalus-pusat-putra
...
export default function HeroSection() {
  ...
  return (
    <section
      ref={ref}
      aria-label="Hero — Beranda Al-Andalus Putra"
          ...
          >
            ...
            >
              <Image
                ...
                alt={`${BRANDING.schoolName} — Pesantren Al-Andalus Putra`}
                width={800}
                height={600}
                priority
