...
const DEFAULT_APP_URL = process.env.NEXT_PUBLIC_APP_URL || BRANDING.websiteUrl || "https://pesantren-alandalus-putra.com";
...
Alhamdulillah, pendaftaran Anda di Pesantren Islam Internasional Al-Andalus Putra telah berhasil!
...
Alhamdulillah, kami dengan senang hati mengumumkan bahwa Anda *DITERIMA* di Pesantren Islam Internasional Al-Andalus Putra!
...
Selamat bergabung di keluarga besar Al-Andalus Putra! ðŸŽ“
...
Berdasarkan hasil seleksi PPDB Pesantren Islam Internasional Al-Andalus Putra, kami informasikan bahwa Anda dinyatakan *CADANGAN*.
...
Berdasarkan hasil seleksi PPDB Pesantren Islam Internasional Al-Andalus Putra, kami informasikan bahwa Anda *BELUM DITERIMA* pada periode ini.
...
Alhamdulillah, Anda telah menyelesaikan seluruh rangkaian ujian/seleksi masuk Pesantren Islam Internasional Al-Andalus Putra.
