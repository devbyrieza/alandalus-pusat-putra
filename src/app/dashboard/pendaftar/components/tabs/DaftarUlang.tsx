    ...
    <div className="space-y-8 max-w-4xl mx-auto pb-12">
              ...
              >
                <div>
                  ...
                  {p.catatan && p.status_pembayaran === "rejected" && (
                    <p className="text-xs text-rose-600 mt-1 font-semibold bg-rose-50 p-2 rounded-xl border border-rose-100">
        ...
        <div className="bg-primary-50 p-6 rounded-xl border border-primary-100 flex flex-col justify-between">
          ...
          <div className="pt-4 border-t border-primary-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-1 sm:grid-cols-2 gap-2 mt-2">
              <a
                href="https://wa.me/6285894111050?text=Assalamualaikum%20Admin%20Finance%2C%20saya%20wali%20dari%20calon%20santri%20ingin%20berkonsultasi%2Fmengajukan%20keringanan%20terkait%20biaya%20Daftar%20Ulang."
                target="_blank"
                rel="noreferrer"
      ...
      {message && message.type === "success" && (
        <div className="p-5 bg-emerald-50 border border-emerald-200 rounded-xl flex flex-col sm:flex-row items-center sm:items-start gap-4 shadow-sm">
          <div className="w-12 h-12 bg-emerald-100 rounded-xl flex items-center justify-center shrink-0 mt-0.5 whitespace-nowrap inline-block shrink-0">
