...
> = {
  ...
  accepted: {
    ...
    icon: Trophy,
    message:
      "Alhamdulillah! Selamat, putra/putri Anda diterima di Pesantren Islam Internasional Al-Andalus Putra!" },
  payment_rejected: {
  ...
  const CardContent = (
    ...
    >
      <div className="flex items-start justify-between mb-8">
        ...
        <span
          className={`px-4 py-1.5 rounded-xl text-[10px] font-black uppercase tracking-widest ${disabled ? "bg-ink-100 text-ink-600" : "bg-amber-400 text-primary-950 shadow-lg shadow-emerald-900/20"}`}
        >
        ...
        <Container>
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-12">
            <div className="max-w-3xl">
              ...
              >
                <div className="w-10 h-10 rounded-xl bg-primary-50 flex items-center justify-center text-primary-600 border border-primary-100 shadow-lg shadow-emerald-900/20">
        ...
        <div className="grid lg:grid-cols-12 gap-12 items-start">
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <div className="mt-12 flex flex-wrap gap-4">
                  <div className="px-5 md:px-8 py-3 rounded-xl bg-primary-50 border border-primary-100 text-[10px] font-black uppercase tracking-[0.2em] text-primary-700 shadow-lg shadow-emerald-900/20">
          ...
          <aside className="lg:col-span-4 space-y-10 overscroll-contain">
            ...
            >
              ...
              <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-[1.5rem] sm:rounded-[2rem] bg-primary-50 flex items-center justify-center text-primary-600 mb-6 sm:mb-8 border border-primary-100 shadow-lg shadow-emerald-900/20 transition-transform group-hover:scale-110">
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <a
                  ...
                  className="flex items-center gap-5 p-6 rounded-[2rem] bg-white hover:bg-amber-400 transition-all group/btn shadow-lg active:scale-95"
                >
