...
export default function RekapFeePengujiPage() {
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto pb-10">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-white p-6 rounded-xl border border-ink-100 shadow-lg shadow-emerald-900/20">
        ...
        <div className="flex items-center gap-3 w-full md:w-auto">
          ...
          <Button
            ...
            className="rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white font-black shadow-lg shadow-emerald-600/20 h-11"
          >
