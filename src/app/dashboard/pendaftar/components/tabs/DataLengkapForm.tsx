  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3">
        {isCompleted && (
          <span className="px-3 py-1 bg-emerald-100 text-emerald-700 text-xs font-bold rounded-xl uppercase tracking-wide whitespace-nowrap inline-block shrink-0">
            Lengkap
          </span>
        )}
        <div
      ...
      {isEditMode ? (
        <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-5 shadow-sm">
          <div className="flex items-start gap-4">
            <div className="w-10 h-10 bg-emerald-100 rounded-xl flex items-center justify-center shrink-0 whitespace-nowrap inline-block shrink-0">
