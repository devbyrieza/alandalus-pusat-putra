  ...
  return (
    <div className="min-h-screen flex flex-col overflow-x-hidden">
      ...
      <div className={`w-full py-2 sm:py-2.5 text-xs font-bold text-white ${c.bg600} flex flex-wrap items-center justify-center gap-x-2 gap-y-0.5 px-8`}>
        ...
        <Link href="/ppdb" className="inline-flex items-center gap-1 ml-2 px-2.5 py-0.5 rounded-full bg-amber-400 hover:bg-amber-300 text-slate-950 text-[11px] font-black uppercase tracking-wider shadow-lg shadow-emerald-900/20 transition-all shrink-0">
          <span>Daftar</span>
                ...
                <div className="relative -mt-6 sm:-mt-8 mx-4 sm:-mx-6 z-20">
                  <div className="bg-slate-900/80  border border-white/20 rounded-xl p-4 sm:p-5 flex items-center gap-4 shadow-lg shadow-black/40 ring-1 ring-white/10">
                    ...
                    <div>
                      ...
                      <p className="text-amber-300 text-[11px] sm:text-xs font-bold tracking-wide drop-shadow-lg shadow-emerald-900/20">Angkatan IX · Kuota Terbatas</p>
                    </div>
                    <Link
                      href="/ppdb"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <header className="text-center mb-16">
            ...
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-black text-slate-900 mt-3 mb-4 text-balance">
              Kurikulum{" "}
              <span className="box-decoration-clone text-transparent bg-clip-text bg-gradient-to-r from-emerald-700 via-teal-600 to-emerald-800 pr-1">
                TICE
              </span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* T — Tahfizh (large) */}
            <div className="md:col-span-2 rounded-xl p-8 bg-gradient-to-br from-[#064e3b] via-[#047857] to-[#022c22] border border-emerald-400/30 text-white relative overflow-hidden group hover:-translate-y-2 hover:shadow-lg transition-all duration-300">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            {[
              { src: "/images/gedung-utama-putra.webp", label: "Gedung Utama & Asrama" },
                ...
                { src: "/images/Gedung Utama Andalus Putra.jpeg", label: "Lapangan Basket" },
            ].map((photo, i) => (
