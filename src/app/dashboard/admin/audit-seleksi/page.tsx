                    ...
                    >
                        ...
                        return (
                          <td key={i} className="px-3 py-4 text-center">
                            <div className="flex flex-col items-center gap-1">
                              <span className={`${g.color} text-white text-[10px] font-black w-6 h-6 flex items-center justify-center rounded-xl shadow-lg shadow-emerald-900/20`}>
                                {g.label}
                              </span>
                      ...
                      <td className="px-6 py-4 text-center">
                        {(() => {
                          ...
                          return (
                            <span className={`px-3 py-1 rounded-full text-[9px] font-black border uppercase shadow-lg shadow-emerald-900/20 ${meta.c}`}>
                              {meta.l}
                            </span>
                          );
                        })()}
      ...
      <div className="grid grid-cols-1 md:grid-cols-1 sm:grid-cols-2 gap-6 mt-8">
          ...
          <div className="relative z-10">
            ...
            <div className="space-y-3 text-sm font-medium leading-relaxed">
              <p className="flex items-start gap-2 !text-white">
                <div className="w-1.5 h-1.5 rounded-full bg-emerald-400 mt-1.5 shrink-0 shadow-lg shadow-emerald-900/20 shadow-emerald-900/50" />
              ...
              <p className="flex items-start gap-2 !text-white">
                <div className="w-1.5 h-1.5 rounded-full bg-secondary-400 mt-1.5 shrink-0 shadow-lg shadow-emerald-900/20 shadow-secondary-900/50" />
                <span><b className="font-extrabold text-secondary-400">CADANGAN:</b> Quran Grade B, atau Wawancara Santri Grade B.</span>
              </p>
              <p className="flex items-start gap-2 !text-white">
                <div className="w-1.5 h-1.5 rounded-full bg-rose-400 mt-1.5 shrink-0 shadow-lg shadow-emerald-900/20 shadow-rose-900/50" />
        ...
        <div className="bg-white rounded-xl p-5 md:p-8 border border-ink-100 shadow-premium-sm flex flex-col justify-between">
          ...
          <div className="mt-8 flex items-center gap-4 p-4 bg-primary-50 rounded-xl border border-primary-100">
             <div className="p-3 bg-white rounded-xl shadow-lg shadow-emerald-900/20">
