...
$tempDir = "$env:TEMP\docx_extract_redo"
...
# 4. Save XML with UTF8 without BOM (very important for Word)
...
# 6. Convert to PDF using VBScript
...
# 7. Copy to all three repositories (PDF with spaces)
...
Write-Host "Redo finished successfully!"
