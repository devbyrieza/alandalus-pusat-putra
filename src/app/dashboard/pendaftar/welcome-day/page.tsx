...
export default function WelcomeDayPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="p-5 space-y-6">
          ...
          <div>
            <div className="flex items-center gap-2 mb-3">
              <div className="w-6 h-6 rounded-full bg-emerald-100 text-emerald-700 flex items-center justify-center font-black text-xs shadow-lg shadow-emerald-900/20">
                1
              </div>
      ...
      {lightbox && (
        <div 
          className="fixed inset-0 z-[100] bg-ink-950/95 flex flex-col items-center justify-center px-7 py-6 md:p-8 "
