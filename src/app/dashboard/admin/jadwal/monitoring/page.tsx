        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                    <div className="w-12 h-12 bg-primary-600 rounded-3xl flex items-center justify-center text-white shadow-lg shadow-primary-600/20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-6">
                <div className="bg-white rounded-3xl p-4 md:p-6 border border-slate-100 shadow-clay-sm relative overflow-hidden group">
            ...
            {conflicts.length > 0 && (
                <motion.div 
                    ...
                    className="bg-rose-50 border border-rose-200 rounded-3xl p-5 flex items-start gap-4 shadow-xl shadow-emerald-900/20 shadow-rose-100"
                >
            ...
            <div className="flex flex-col gap-4">
                <div className="flex flex-col md:flex-row gap-3">
                    ...
                    <div className="flex-1 flex gap-2">
                        <div className="relative flex-1">
                            ...
                            <input 
                                ...
                                className="w-full bg-white border border-slate-200 rounded-3xl pl-10 pr-4 py-2 text-sm focus:ring-4 focus:ring-primary-500/5 focus:border-primary-500 outline-none font-bold h-12 transition-all shadow-xl shadow-emerald-900/20"
                            />
                        </div>
                        <select 
                            value={filterJenjang}
                            onChange={(e) => setFilterJenjang(e.target.value)}
                            className="w-32 bg-white border border-slate-200 rounded-3xl px-3 py-2 text-[11px] font-black text-ink-600 focus:ring-4 focus:ring-primary-500/5 focus:border-primary-500 outline-none h-12 shadow-xl shadow-emerald-900/20 appearance-none text-center uppercase tracking-wider"
                        >
                    ...
                    <div className="flex items-center gap-2">
                        <div className="flex-1 md:flex-none flex bg-slate-100 p-1.5 rounded-3xl h-12 min-w-fit">
                            {[
                                { id: "flat", label: "List" },
                                ...
                                <button 
                                    ...
                                    className={`px-5 rounded-3xl text-[11px] font-bold uppercase tracking-wider transition-all ${viewMode === mode.id ? "bg-white text-primary-700 shadow-xl shadow-emerald-900/20" : "text-slate-400 hover:text-slate-600"}`}
                                >
                                    {mode.label}
                                </button>
                            ))}
                        ...
                        <button 
                            ...
                            className="w-12 h-12 bg-white border border-slate-200 hover:bg-slate-50 text-slate-700 rounded-3xl shadow-xl shadow-emerald-900/20 transition-all flex items-center justify-center shrink-0"
                            title="Refresh Data"
                        >
                        ...
                        <button 
                            ...
                            className={`px-4 rounded-3xl text-[11px] font-bold uppercase tracking-wider transition-all border h-12 shadow-xl shadow-emerald-900/20 ${
                                showPast 
                        ...
                        {getGroupedBySantri().map((group) => (
                            <div key={group.name} className="bg-white rounded-[2rem] shadow-clay-m border border-slate-100 overflow-hidden flex flex-col transition-all hover:translate-y-[-4px] group">
                                <div className="bg-slate-50 px-6 py-6 border-b border-slate-100 group-hover:bg-primary-50/50 transition-colors">
                                    <div className="flex items-center gap-4">
                                        <div className="w-12 h-12 bg-white rounded-3xl flex items-center justify-center shadow-xl shadow-emerald-900/20 border border-slate-100">
                                ...
                                <div className="p-5 flex-1 space-y-4">
                                    {group.items.map((s, idx) => (
                                        <div key={`${s.id}-${idx}`} className="bg-slate-50/30 rounded-3xl p-4 border border-slate-100/50">
