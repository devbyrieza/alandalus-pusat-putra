  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto px-7 py-6 md:p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-green-50 p-6 rounded-xl shadow-lg shadow-emerald-900/20 border border-green-100 relative overflow-hidden">
        ...
        <div className="bg-secondary-50 p-6 rounded-xl shadow-lg shadow-emerald-900/20 border border-secondary-100 relative overflow-hidden">
        ...
        <div className="bg-rose-50 p-6 rounded-xl shadow-lg shadow-emerald-900/20 border border-rose-100 relative overflow-hidden">
      ...
      {/* Filters & Actions */}
      <div className="bg-white p-4 rounded-xl shadow-lg shadow-emerald-900/20 border border-stone-200 flex flex-col md:flex-row justify-between items-center gap-4">
      ...
      {/* Table & Mobile View */}
      <div className="bg-white rounded-xl shadow-lg shadow-emerald-900/20 border border-stone-200 overflow-hidden">
        {/* Mobile View: Cards */}
            ...
            candidates.map((c) => (
              <div key={c.id} className="p-5 space-y-4">
                <div className="flex justify-between items-start gap-4 flex-wrap">
                  ...
                  <span className="px-2 py-0.5 bg-stone-100 text-stone-600 rounded text-[9px] font-black uppercase shrink-0 border border-stone-200 shadow-lg shadow-emerald-900/20 whitespace-nowrap inline-block shrink-0">
                    {c.jenjang}
                  </span>
                </div>
                ...
                candidates.map((c) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <span className="px-2 py-1 bg-stone-100 text-stone-700 rounded-md text-xs font-bold border border-stone-200 shadow-lg shadow-emerald-900/20 whitespace-nowrap inline-block shrink-0">
                          {c.jenjang}
                        </span>
                      </td>
                      <td className="px-6 py-4">
