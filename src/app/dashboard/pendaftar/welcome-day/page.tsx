  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-1 gap-4">
        ...
        >
          <div className="w-10 h-10 rounded-xl bg-emerald-100 text-emerald-600 flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform whitespace-nowrap shrink-0">
      ...
      <div className="bg-white rounded-xl border border-ink-100 shadow-lg shadow-emerald-900/20 overflow-hidden mb-6">
        <div className="px-6 py-4 border-b border-emerald-100 bg-emerald-50 flex items-center gap-3">
          <div className="w-9 h-9 bg-emerald-100 rounded-xl flex items-center justify-center whitespace-nowrap shrink-0">
        ...
        <div className="p-5 space-y-6">
          ...
          <div>
            <div className="flex items-center gap-2 mb-3">
              <div className="w-6 h-6 rounded-full bg-emerald-100 text-emerald-700 flex items-center justify-center font-black text-xs shadow-lg shadow-emerald-900/20 whitespace-nowrap shrink-0">
                1
              </div>
