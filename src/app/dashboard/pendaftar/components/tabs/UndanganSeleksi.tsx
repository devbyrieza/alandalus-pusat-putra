...
export default function UndanganSeleksiTab() {
  ...
  if (data.condition === "seleksi_selesai") {
    return (
      <div className="space-y-6">
        {/* Header */}
        <div className="bg-linear-to-r from-emerald-700 to-emerald-900 rounded-xl p-6 md:p-8 text-white shadow-lg relative overflow-hidden">
        ...
        <div className="grid md:grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          {data.current_status === "enrolled" ? (
            <div className="bg-emerald-50 rounded-xl border-2 border-emerald-200 p-6 shadow-sm">
              <div className="flex items-center gap-3 mb-3">
                <div className="w-12 h-12 bg-emerald-100 rounded-xl flex items-center justify-center whitespace-nowrap inline-block shrink-0">
