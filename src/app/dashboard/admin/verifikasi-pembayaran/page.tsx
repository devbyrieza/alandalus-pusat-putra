                ...
                <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-6">
                  ...
                  <div className="flex sm:flex-col gap-3 sm:w-48 shrink-0">
                    ...
                    {statusFilter === "verified" && (
                      <button
                        onClick={() => openModal(pay)}
                        className="flex-1 sm:flex-none flex items-center justify-center gap-2 px-4 py-3 bg-emerald-50 hover:bg-emerald-100 text-emerald-700 rounded-xl font-bold text-sm border border-emerald-100 transition-all whitespace-nowrap shrink-0"
                      >
                        <CheckCircle className="w-4 h-4" />
                        Terverifikasi
                      </button>
