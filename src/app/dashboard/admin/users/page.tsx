                  ...
                  >
                    <td className="p-5 md:p-8">
                      <div className="flex items-center gap-5">
                        <div className="w-12 h-12 rounded-xl bg-primary-100 flex items-center justify-center text-primary-700 font-black text-xs border-2 border-white shadow-lg shadow-emerald-900/20 whitespace-nowrap inline-block shrink-0">
                        ...
                        {user.secondary_roles &&
                          user.secondary_roles
                            ...
                            .map((r, i) => (
                              <span
                                key={i}
                                className="px-4 py-1.5 bg-stone-100 text-stone-600 text-[10px] font-black rounded-xl border border-stone-200 uppercase tracking-widest shadow-lg shadow-emerald-900/20 whitespace-nowrap inline-block shrink-0"
                              >
