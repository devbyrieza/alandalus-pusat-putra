      ...
      <div className="bg-white rounded-[2rem] md:rounded-[2.5rem] p-5 md:p-8 shadow-clay-lg border border-white/40 overflow-hidden relative">
        ...
        <div className="relative flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
          <div className="flex items-center gap-4 md:gap-6">
            <div className="p-3 md:p-4 bg-linear-to-br from-primary-600 to-primary-800 rounded-3xl md:rounded-3xl shadow-xl shadow-primary-600/20 shrink-0">
          ...
          <div className="flex gap-2 md:gap-3">
            <Button
              ...
              className="flex-1 md:flex-none bg-emerald-50 text-emerald-700 border-emerald-100 hover:bg-emerald-100 rounded-3xl h-11 md:h-12 px-4 md:px-6 font-black shadow-none transition-all text-sm"
            >
              <Download className="w-4 h-4 mr-1.5" /> Excel
            </Button>
            <Button
              onClick={exportToPDF}
              className="flex-1 md:flex-none bg-red-50 text-red-700 border-red-100 hover:bg-red-100 rounded-3xl h-11 md:h-12 px-4 md:px-6 font-black shadow-none transition-all text-sm"
            >
            ...
            <Button
              ...
              disabled={loading}
              variant="outline"
              className="rounded-3xl h-11 md:h-12 px-4 md:px-6 border-ink-100 hover:bg-amber-50 font-black"
            >
              <RefreshCcw
                  ...
                  >
                    <td className="px-6 py-6">
                      <div className="flex items-center gap-4">
                        <div className="w-10 h-10 rounded-3xl bg-amber-100 flex items-center justify-center text-primary-900 font-black shadow-xl shadow-emerald-900/20 border border-amber-200">
                          {item.name.charAt(0)}
                        </div>
                        <div>
            ...
            filteredRecap.map((item) => (
              ...
              >
                ...
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-11 h-11 rounded-3xl bg-amber-100 flex items-center justify-center text-primary-900 font-black text-lg border border-amber-200 shrink-0">
                    {item.name.charAt(0)}
                  </div>
                ...
                <div className="mb-3 bg-linear-to-r from-primary-700 to-primary-800 rounded-3xl px-4 py-3 flex items-center justify-between">
                  <div>
