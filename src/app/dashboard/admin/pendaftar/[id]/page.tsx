      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {isKeuangan && (
            <div className="bg-white rounded-xl shadow-lg shadow-emerald-900/20 p-6 border border-amber-100">
              <div className="flex items-center gap-3 mb-6">
                <div className="p-3 bg-amber-100 rounded-xl shadow-lg shadow-emerald-900/20">
                        ...
                        <div className="flex flex-col items-end gap-2">
                          ...
                          {(!payment.bukti_transfer_path || payment.status_pembayaran !== "verified") && (
                            <button
                              ...
                              className="px-3 py-1 bg-white hover:bg-amber-100 text-amber-700 rounded-xl text-[10px] font-black uppercase tracking-wider transition-all flex items-center gap-1.5 border border-amber-200 disabled:opacity-50"
                            >
