...
export default function LoginPage() {
  ...
  return (
    <div
      style={{
        minHeight: "100vh",
        background: "linear-gradient(135deg, #021712 0%, #042f24 30%, #064e3b 60%, #086b51 100%)",
        display: "flex",
        alignItems: "center",
    ...
    >
      ...
      >
        ...
        >
          ...
          {roleSelectionData ? (
            ...
            <>
              ...
              >
                <button
                  ...
                  style={{
                    ...
                    color: activeTab === "pendaftar" ? "#064e3b" : "#64748b",
                ...
                <button
                  ...
                  style={{
                    ...
                    color: activeTab === "admin" ? "#064e3b" : "#64748b",
              ...
              >
                <span style={{ color: "#064e3b", fontWeight: 500 }}>
                ...
                <form onSubmit={handleLoginPendaftar} style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
                    ...
                    <div style={{ position: "relative" }}>
                      ...
                      <input
                        ...
                        onFocus={(e) => {
                          ...
                          e.target.style.boxShadow = "0 0 0 4px rgba(6,78,59,0.08)";
                        }}
                        onBlur={(e) => {
                  ...
                  <button
                    ...
                    style={{
                      ...
                      height: "50px",
                      borderRadius: "12px",
                      background: isLoading ? "#64748b" : "linear-gradient(135deg, #042f24 0%, #064e3b 100%)",
                      color: "#ffffff",
                      fontWeight: 800,
                      fontSize: "13px",
                      letterSpacing: "0.02em",
                      ...
                      justifyContent: "center",
                      gap: "8px",
                      boxShadow: isLoading ? "none" : "0 8px 24px rgba(6,78,59,0.35)",
                      transition: "all 0.2s",
                      fontFamily: "inherit",
        ...
        <div style={{ display: "flex", gap: "8px", justifyContent: "center", flexWrap: "wrap" }}>
          <div key="Formulir Putra" style={{ display: "inline-flex", alignItems: "center", gap: "6px", padding: "6px 14px", borderRadius: "100px", background: "rgba(255,255,255,0.08)", border: "1px solid rgba(255,255,255,0.12)", backdropFilter: "blur(8px)" }}><span style={{ width: 6, height: 6, borderRadius: "50%", background: "#34d399", display: "inline-block", flexShrink: 0 }} /><span style={{ fontSize: "10px", fontWeight: 600, color: "rgba(255,255,255,0.7)", letterSpacing: "0.03em" }}>Formulir Putra</span></div>
