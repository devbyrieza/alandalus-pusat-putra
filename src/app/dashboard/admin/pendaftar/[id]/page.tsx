...
export default function PendaftarDetailPage() {
  ...
  const formatStatus = (status: string, dataLengkap?: any) => {
    ...
    const statusMap: Record<string, { label: string; color: string }> = {
      ...
      tested: {
        label: "Proses Seleksi",
        color: "bg-primary-600 text-white shadow-xl shadow-emerald-900/20",
      },
      exam_completed: {
        label: "Proses Seleksi",
        color: "bg-primary-600 text-white shadow-xl shadow-emerald-900/20",
    ...
    <div className="space-y-6">
      ...
      <div className="bg-linear-to-br from-primary-600 to-primary-900 rounded-3xl shadow-xl shadow-primary-900/20 p-5 md:p-8 text-white relative overflow-hidden">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 relative z-10">
          ...
          <div className="flex items-center gap-5">
            <div className="w-20 h-20 bg-white/20 backdrop-blur-md rounded-3xl flex items-center justify-center text-amber-300 shadow-inner">
            ...
            <div>
              ...
              <div className="flex flex-wrap items-center gap-3 mt-2">
                ...
                <span className="px-2.5 py-1 bg-amber-400 text-primary-900 rounded-lg text-xs font-black uppercase shadow-xl shadow-emerald-900/20">
                  {pendaftar.jenjang}
                </span>
          ...
          <div className="flex flex-wrap gap-4">
            <div className="bg-white/10 backdrop-blur-md rounded-3xl px-5 py-4 min-w-[120px] border border-white/10">
        ...
        <div className="mt-6 pt-6 border-t border-white/20 flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="px-4 py-2 bg-rose-600 hover:bg-rose-700 text-white rounded-3xl text-xs font-black transition-all flex items-center gap-1 disabled:opacity-50 shadow-xl shadow-emerald-900/20 active:scale-95"
            >
            ...
            {pendaftar.no_hp && (
              <a
                ...
                className="px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white rounded-3xl text-xs font-black transition-all flex items-center gap-1 shadow-xl shadow-emerald-900/20 active:scale-95"
              >
            ...
            {userRole === "admin_super" && (
              <>
                <button
                  ...
                  className="px-4 py-2 bg-purple-600 hover:bg-purple-700 text-white rounded-3xl text-xs font-black transition-all flex items-center gap-1.5 shadow-xl shadow-emerald-900/20 active:scale-95 border border-purple-500 mr-2"
                >
                ...
                <button
                  ...
                  className="px-4 py-2 bg-amber-400 hover:bg-yellow-500 text-primary-900 rounded-3xl text-xs font-black transition-all flex items-center gap-1.5 shadow-xl shadow-emerald-900/20 active:scale-95 border border-amber-300 mr-2"
                >
                ...
                <button
                  ...
                  disabled={exporting}
                  className="px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white rounded-3xl text-xs font-black transition-all flex items-center gap-1.5 shadow-xl shadow-emerald-900/20 active:scale-95 mr-2"
                >
                ...
                <button
                  ...
                  disabled={exporting}
                  className="px-4 py-2 bg-rose-600 hover:bg-rose-700 text-white rounded-3xl text-xs font-black transition-all flex items-center gap-1.5 shadow-xl shadow-emerald-900/20 active:scale-95 mr-2"
                >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {isBerkas && (
            <div className="bg-white rounded-3xl shadow-xl shadow-emerald-900/20 p-6 border border-amber-100">
          ...
          {(isPenguji ||
            ...
            <div className="bg-white rounded-3xl shadow-xl shadow-emerald-900/20 p-6 border border-amber-100">
              <div className="flex items-center gap-3 mb-6">
                <div className="p-3 bg-amber-50 rounded-3xl">
              ...
              {userRole === "admin_super" && (
                <div className="mb-6 p-4 bg-blue-50 border border-blue-100 rounded-3xl flex flex-col sm:flex-row sm:items-center gap-3">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <a
                      ...
                      target="_blank"
                      className="px-3 py-1.5 bg-blue-600 hover:bg-blue-700 text-white rounded-3xl text-[11px] font-bold transition-colors shadow-xl shadow-emerald-900/20"
                    >
                      Buka CBT Akademik
                    </a>
                    <a
                      ...
                      target="_blank"
                      className="px-3 py-1.5 bg-purple-600 hover:bg-purple-700 text-white rounded-3xl text-[11px] font-bold transition-colors shadow-xl shadow-emerald-900/20"
                    >
                    ...
                    <a
                      ...
                      target="_blank"
                      className="px-3 py-1.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded-3xl text-[11px] font-bold transition-colors shadow-xl shadow-emerald-900/20"
                    >
                      Buka CBT Kesiapan
                    </a>
                  </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div className="bg-primary-50/50 p-4 rounded-3xl border border-primary-100 relative">
                ...
                <div className="bg-emerald-50/50 p-4 rounded-3xl border border-emerald-100 flex flex-col justify-between">
                  <div>
                ...
                {(pendaftar?.jenjang?.toLowerCase() || "").includes("ma") && (
                  <div className="bg-teal-50/50 p-4 rounded-3xl border border-teal-100 flex flex-col justify-between">
                    <div>
                ...
                {(pendaftar?.jenjang?.toLowerCase() || "").includes("ma") && (
                  <div className="bg-sky-50/50 p-4 rounded-3xl border border-sky-100 flex flex-col justify-between">
                    <div>
                ...
                <div className="bg-secondary-50/50 p-4 rounded-3xl border border-secondary-100 flex flex-col justify-between">
                  <div>
                ...
                <div className="bg-rose-50/50 p-4 rounded-3xl border border-rose-100 flex flex-col justify-between">
                  <div>
          ...
          {(userRole === "admin_super" || userRole === "admin") && 
            ...
            <div className="bg-white rounded-3xl shadow-xl shadow-emerald-900/20 p-6 border border-emerald-100">
              <div className="flex items-center gap-3 mb-6">
              ...
              {!pendaftar.reservasi || pendaftar.reservasi.length === 0 ? (
                <div className="p-4 bg-stone-50 border border-stone-200 rounded-3xl flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="px-4 py-2 bg-emerald-600 text-white rounded-3xl text-xs font-black"
                  >
                    Input Data
                  </button>
                </div>
                ...
                <div className="space-y-4">
                  {pendaftar.reservasi.map((res: any) => {
                    ...
                    return (
                      <div key={res.id} className="p-5 bg-emerald-50/50 rounded-3xl border border-emerald-100 shadow-xl shadow-emerald-900/20 relative">
          ...
          {isKeuangan && (
            <div className="bg-white rounded-3xl shadow-xl shadow-emerald-900/20 p-6 border border-amber-100">
              <div className="flex items-center gap-3 mb-6">
                <div className="p-3 bg-amber-100 rounded-3xl shadow-xl shadow-emerald-900/20">
              ...
              {pendaftar.pembayaran.length === 0 ? (
                ...
                <div className="space-y-4">
                  {pendaftar.pembayaran.map((payment) => (
                    <div
                      key={payment.id}
                      className="p-4 bg-amber-50/50 rounded-3xl border border-amber-100 shadow-xs"
                    >
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-1 sm:grid-cols-2 gap-4 pt-2 border-t border-amber-200/50">
                        <div>
          ...
          {pendaftar.orang_tua && (
            <div className="bg-white rounded-3xl shadow-xl shadow-emerald-900/20 p-6 border border-amber-100">
              <div className="flex items-center gap-3 mb-6">
                <div className="p-3 bg-amber-100 rounded-3xl">
            ...
            <form onSubmit={handleSaveEdit} className="flex-1 overflow-y-auto p-5 md:p-8 space-y-6 overscroll-contain custom-scrollbar">
              ...
              <div className="border-t border-stone-200 pt-6 flex items-center justify-end gap-3 sticky bottom-0 bg-white">
                ...
                <button
                  type="submit"
                  disabled={savingEdit}
                  className="px-6 py-3 bg-primary-600 hover:bg-primary-700 text-white rounded-3xl font-black text-sm uppercase transition-all shadow-md flex items-center gap-2 disabled:opacity-50"
                >
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
          ...
          <div className="relative w-full max-w-md bg-white rounded-[2rem] shadow-2xl flex flex-col max-h-[90vh] overflow-hidden animate-in fade-in zoom-in-95 duration-200">
            <div className="px-6 md:px-8 py-6 border-b border-surface-100 flex items-center justify-between shrink-0 bg-surface-50/50">
              ...
              <button
                onClick={() => setIsNilaiModalOpen(false)}
                className="p-2 hover:bg-surface-200 rounded-3xl transition-colors text-ink-500"
              >
                <X className="w-5 h-5" />
              </button>
            </div>
            ...
            <form onSubmit={handleSaveNilaiManual} className="p-6 md:p-8 overflow-y-auto custom-scrollbar flex-1 overscroll-contain">
              <div className="space-y-4">
                <div className="bg-amber-50 text-amber-800 p-4 rounded-3xl text-sm mb-4 border border-amber-200 font-medium">
              ...
              <div className="pt-6 mt-6 border-t border-surface-100 flex justify-end gap-3">
                ...
                <button
                  ...
                  className="px-6 py-2.5 bg-amber-600 hover:bg-amber-700 text-white rounded-3xl font-black text-sm uppercase transition-all shadow-md disabled:opacity-50"
                >
          ...
          <div className="bg-white w-full max-w-lg rounded-3xl shadow-2xl flex flex-col max-h-[90vh]">
            <div className="flex items-center justify-between p-6 border-b border-surface-100 bg-surface-50 rounded-t-3xl">
              ...
              <button
                ...
                className="p-2 text-ink-300 hover:text-ink-600 hover:bg-surface-200 rounded-3xl transition-colors"
              >
                <X className="w-5 h-5" />
              </button>
            </div>
            ...
            <div className="p-6 border-t border-surface-100 bg-surface-50 rounded-b-3xl flex justify-end gap-3">
              ...
              <button
                ...
                className="px-6 py-2.5 rounded-3xl bg-emerald-600 hover:bg-emerald-700 text-white font-black shadow-lg shadow-emerald-500/30 transition-all active:scale-95 disabled:opacity-50"
              >
