    ...
    <div className="px-7 py-6 md:p-8 max-w-7xl mx-auto h-full space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-white rounded-xl p-6 border border-slate-200 shadow-lg shadow-emerald-900/20 flex items-center gap-4">
          <div className="w-14 h-14 rounded-xl bg-amber-100 flex items-center justify-center text-amber-600 shrink-0 whitespace-nowrap shrink-0">
        ...
        <div className="bg-white rounded-xl p-6 border border-slate-200 shadow-lg shadow-emerald-900/20 flex items-center gap-4">
          <div className="w-14 h-14 rounded-xl bg-emerald-100 flex items-center justify-center text-emerald-600 shrink-0 whitespace-nowrap shrink-0">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        {/* CHART: Revenue Trend */}
        <div className="lg:col-span-2 bg-white p-6 md:p-8 rounded-xl border border-slate-200 shadow-lg shadow-emerald-900/20">
        ...
        {/* CHART: SPP Status */}
        <div className="lg:col-span-1 bg-white p-6 md:p-8 rounded-xl border border-slate-200 shadow-lg shadow-emerald-900/20 flex flex-col">
