...
export default function JadwalUjianPage() {
  ...
  const [newSession, setNewSession] = useState({
    ...
    end_time: "",
    quota: 10,
    location: "Pesantren Islam Internasional Al-Andalus Putra",
    notes: "",
  });
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto">
      {/* Header */}
      <div className="bg-white rounded-3xl shadow-clay-lg p-5 md:p-8 border border-white/40 overflow-hidden relative">
        ...
        <div className="relative flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="flex items-center gap-6">
            <div className="p-4 bg-gradient-to-br from-purple-500 to-indigo-600 rounded-3xl shadow-lg shadow-purple-500/20">
            ...
            <div>
              ...
              <p className="text-emerald-900/60 font-medium">
                Panel Pengaturan Jadwal Seleksi PPDB Al-Andalus Putra
              </p>
            </div>
          </div>
          <div className="flex flex-col md:flex-row gap-3">
            <button
              ...
              className="flex items-center gap-3 px-6 py-3 bg-indigo-50 hover:bg-indigo-100 text-indigo-700 rounded-3xl font-black border border-indigo-200 transition-all"
            >
            ...
            <button
              ...
              className="flex items-center gap-3 px-6 py-3 bg-purple-600 hover:bg-purple-700 text-white rounded-3xl font-black shadow-lg shadow-purple-600/20 transition-all hover:-translate-y-0.5"
            >
      ...
      <div className="grid grid-cols-1 md:grid-cols-1 sm:grid-cols-2 gap-6">
        <div className="bg-gradient-to-br from-indigo-600 to-purple-700 rounded-3xl p-6 text-white shadow-lg overflow-hidden relative">
        ...
        <div className="bg-white rounded-3xl p-6 border border-indigo-100 shadow-clay-md flex items-center gap-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-8 space-y-4">
          ...
          <div className="grid grid-cols-1 gap-4">
            {loading ? (
              <div className="bg-white rounded-3xl p-6 md:p-12 text-center border border-white/40">
                <Loader2 className="w-8 h-8 animate-spin text-purple-500 mx-auto" />
              </div>
            ) : sessions.length === 0 ? (
              <div className="bg-white rounded-3xl p-6 md:p-12 text-center border-2 border-dashed border-ink-100">
              ...
              sessions.map((s) => (
                <div
                  key={s.id}
                  className={`group bg-white rounded-3xl shadow-clay-md border border-white/40 p-6 flex flex-col md:flex-row md:items-center justify-between gap-4 transition-all ${selectedPendaftarId ? "ring-2 ring-purple-100 hover:ring-purple-200" : ""}`}
                >
                  <div className="flex items-start gap-5">
                    <div className="w-14 h-14 rounded-3xl bg-purple-50 flex items-center justify-center text-purple-600 shadow-inner">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-4 mt-2">
                        <span className="flex items-center gap-1.5 text-xs font-bold text-ink-400 uppercase tracking-wider">
                          ...
                          {s.location || "Pesantren Islam Internasional Al-Andalus Putra"}
                        </span>
                  ...
                  <div className="flex items-center gap-3">
                    {selectedPendaftarId ? (
                      <button
                        ...
                        className="w-full md:w-auto px-6 py-3 bg-gradient-to-br from-primary-600 to-emerald-600 text-white rounded-3xl font-black shadow-lg shadow-primary-600/20 hover:scale-105 transition-all flex items-center justify-center gap-2"
                      >
                        {assigning ? (
        ...
        <div className="lg:col-span-4 space-y-4">
          ...
          <div className="bg-white rounded-3xl shadow-clay-md border border-white/40 overflow-hidden flex flex-col h-[600px] sticky top-28">
            ...
            <form onSubmit={handleCreateSession}>
              <div className="p-5 md:p-8 space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-purple-50 rounded-3xl p-4 border border-purple-100 flex items-start gap-3">
              ...
              <div className="px-5 md:px-8 pb-8 flex gap-3">
                <button
                  type="button"
                  onClick={() => setShowAddSession(false)}
                  className="flex-1 py-4 bg-secondary-100 hover:bg-secondary-200 text-ink-600 rounded-3xl font-black transition-all"
                >
                  Batal
                </button>
                <button
                  type="submit"
                  className="flex-[2] py-4 bg-purple-600 hover:bg-purple-700 text-white rounded-3xl font-black shadow-lg shadow-purple-600/20 transition-all"
                >
                  Simpan Sesi
                </button>
              </div>
      ...
      {sendingProgress.active && (
        <div className="fixed inset-0 z-[60] flex items-start md:items-center pt-10 md:pt-0 pb-20 md:pb-0 justify-center p-4 bg-ink-900/80 backdrop-blur-sm overflow-y-auto overflow-x-hidden overscroll-contain custom-scrollbar">
          <div className="bg-white rounded-3xl w-full max-w-md shadow-2xl border border-white p-5 md:p-8 text-center animate-pulse">
            ...
            <div className="bg-secondary-50 rounded-3xl p-4 text-left h-32 overflow-hidden flex flex-col-reverse gap-1 border border-ink-100">
          ...
          <div className="bg-white rounded-3xl w-full max-w-md shadow-clay-lg border border-white overflow-hidden animate-in zoom-in-95 duration-300">
            <div className="p-5 md:p-8 space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div
                  className="flex items-center gap-3 p-4 bg-secondary-50 rounded-3xl cursor-pointer"
                ...
                <div className="bg-secondary-50 rounded-3xl p-4 border border-secondary-100 flex items-start gap-3">
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="flex-[2] py-4 bg-indigo-600 hover:bg-indigo-700 text-white rounded-3xl font-black shadow-lg shadow-indigo-600/20 transition-all flex items-center justify-center gap-2"
                >
