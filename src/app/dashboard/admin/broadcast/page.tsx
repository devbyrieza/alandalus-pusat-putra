    ...
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      <div className="bg-white rounded-3xl shadow-clay-lg p-5 md:p-8 border border-white/40 overflow-hidden relative">
        ...
        <div className="relative flex items-center gap-6">
          <div className="p-4 bg-gradient-to-br from-primary-600 to-emerald-600 rounded-3xl shadow-lg shadow-primary-600/20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-7 space-y-6">
          <div className="bg-white rounded-3xl shadow-clay-md border border-white/40 overflow-hidden flex flex-col h-[700px]">
        ...
        <div className="lg:col-span-5 space-y-6">
          <div className="bg-white rounded-3xl shadow-clay-md border border-white/40 p-6 space-y-6 sticky top-28">
            <h2 className="font-bold text-ink-900 flex items-center gap-2">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Contoh: Tim PSB Al-Andalus Putra"
                  className="w-full bg-secondary-50 border-none rounded-3xl px-4 py-3 text-sm focus:ring-2 focus:ring-primary-600/10 outline-none font-medium"
                />
              </div>
            </div>
            ...
            {/* Preview Card */}
            <div className="bg-secondary-50 rounded-3xl p-4 border border-ink-100">
              <span className="text-[10px] font-black uppercase text-ink-400 tracking-widest block mb-3">
                Pratinjau Pesan (Contoh)
              </span>
              <div className="bg-white rounded-3xl p-4 shadow-xl shadow-emerald-900/20 text-sm whitespace-pre-wrap font-medium text-ink-800 leading-relaxed border border-white/80">
            ...
            <button
              ...
              className="w-full py-4 bg-gradient-to-br from-primary-600 to-emerald-600 text-white rounded-3xl font-black shadow-lg shadow-primary-600/20 hover:shadow-primary-600/30 transition-all flex items-center justify-center gap-3 disabled:opacity-50 disabled:shadow-none"
            >
              {sending ? (
                <>
            ...
            {results && (
              <div
                className={`p-4 rounded-3xl flex items-start gap-3 ${results.failed > 0 ? "bg-red-50 text-red-700" : "bg-green-50 text-green-700"}`}
              >
                {results.failed > 0 ? (
