...
export default function PendaftarDetailPage() {
  ...
  const formatStatus = (status: string, dataLengkap?: any) => {
    ...
    const statusMap: Record<string, { label: string; color: string }> = {
      ...
      tested: {
        label: "Proses Seleksi",
        color: "bg-primary-600 text-white shadow-lg shadow-emerald-900/20" },
      exam_completed: {
        label: "Proses Seleksi",
        color: "bg-primary-600 text-white shadow-lg shadow-emerald-900/20" },
      announced: {
    ...
    <div className="space-y-6">
      ...
      <div className="bg-linear-to-br from-primary-600 to-primary-900 rounded-xl shadow-lg shadow-primary-900/20 p-5 md:p-8 text-white relative overflow-hidden">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 relative z-10">
          ...
          <div className="flex items-center gap-5">
            <div className="w-20 h-20 bg-white/20  rounded-xl flex items-center justify-center text-amber-300 shadow-inner">
            ...
            <div>
              ...
              <div className="flex flex-wrap items-center gap-3 mt-2">
                ...
                <span className="px-2.5 py-1 bg-amber-400 text-primary-900 rounded-xl text-xs font-black uppercase shadow-lg shadow-emerald-900/20">
        ...
        <div className="mt-6 pt-6 border-t border-white/20 flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="px-4 py-2 bg-rose-600 hover:bg-rose-700 text-white rounded-xl text-xs font-black transition-all flex items-center gap-1 disabled:opacity-50 shadow-lg shadow-emerald-900/20 active:scale-95"
            >
            ...
            {pendaftar.no_hp && (
              <a
                ...
                className="px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl text-xs font-black transition-all flex items-center gap-1 shadow-lg shadow-emerald-900/20 active:scale-95"
              >
            ...
            {userRole === "admin_super" && (
              <>
                <button
                  ...
                  className="px-4 py-2 bg-purple-600 hover:bg-purple-700 text-white rounded-xl text-xs font-black transition-all flex items-center gap-1.5 shadow-lg shadow-emerald-900/20 active:scale-95 border border-purple-500 mr-2"
                >
                ...
                <button
                  ...
                  className="px-4 py-2 bg-amber-400 hover:bg-yellow-500 text-primary-900 rounded-xl text-xs font-black transition-all flex items-center gap-1.5 shadow-lg shadow-emerald-900/20 active:scale-95 border border-amber-300 mr-2"
                >
                ...
                <button
                  ...
                  disabled={exporting}
                  className="px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl text-xs font-black transition-all flex items-center gap-1.5 shadow-lg shadow-emerald-900/20 active:scale-95 mr-2"
                >
                ...
                <button
                  ...
                  disabled={exporting}
                  className="px-4 py-2 bg-rose-600 hover:bg-rose-700 text-white rounded-xl text-xs font-black transition-all flex items-center gap-1.5 shadow-lg shadow-emerald-900/20 active:scale-95 mr-2"
                >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {isBerkas && (
            <div className="bg-white rounded-xl shadow-lg shadow-emerald-900/20 p-6 border border-amber-100">
                ...
                <div className="mb-6 p-4 bg-blue-50 border border-blue-100 rounded-xl flex flex-col sm:flex-row sm:items-center gap-3">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <a
                      ...
                      target="_blank"
                      className="px-3 py-1.5 bg-blue-600 hover:bg-blue-700 text-white rounded-xl text-[11px] font-bold transition-colors shadow-lg shadow-emerald-900/20"
                    >
                      Buka CBT Akademik
                    </a>
                    <a
                      ...
                      target="_blank"
                      className="px-3 py-1.5 bg-purple-600 hover:bg-purple-700 text-white rounded-xl text-[11px] font-bold transition-colors shadow-lg shadow-emerald-900/20"
                    >
                    ...
                    <a
                      ...
                      target="_blank"
                      className="px-3 py-1.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl text-[11px] font-bold transition-colors shadow-lg shadow-emerald-900/20"
                    >
                      Buka CBT Kesiapan
                    </a>
                  </div>
              ...
              {isPenguji && (
                <div className="mt-4 flex justify-end">
                  <Link
                    ...
                    className="flex items-center gap-2 px-4 py-2 bg-purple-600 text-white rounded-xl hover:bg-purple-700 transition-colors shadow hover:shadow-md font-bold text-sm"
                  >
          ...
          {(userRole === "admin_super" || userRole === "admin") && 
            ...
            <div className="bg-white rounded-xl shadow-lg shadow-emerald-900/20 p-6 border border-emerald-100">
              <div className="flex items-center gap-3 mb-6">
              ...
              {!pendaftar.reservasi || pendaftar.reservasi.length === 0 ? (
                ...
                <div className="space-y-4">
                  {pendaftar.reservasi.map((res: any) => {
                    ...
                    return (
                      <div key={res.id} className="p-5 bg-emerald-50/50 rounded-xl border border-emerald-100 shadow-lg shadow-emerald-900/20 relative">
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                          <div>
                            ...
                            <span className={`px-2.5 py-1 rounded-xl text-xs font-black ${data.statusKehadiran === 'HADIR' ? 'bg-emerald-100 text-emerald-700' : 'bg-red-100 text-red-700'}`}>
                        ...
                        <div className="mt-4 flex justify-end">
                          <button
                            ...
                            className="flex items-center gap-1.5 px-3 py-1.5 bg-white border border-emerald-200 text-emerald-700 hover:bg-emerald-50 rounded-xl text-xs font-black transition-colors"
                          >
                            <Edit className="w-3.5 h-3.5" />
                            Edit
                          </button>
          ...
          {isKeuangan && (
            <div className="bg-white rounded-xl shadow-lg shadow-emerald-900/20 p-6 border border-amber-100">
              <div className="flex items-center gap-3 mb-6">
                <div className="p-3 bg-amber-100 rounded-xl shadow-lg shadow-emerald-900/20 whitespace-nowrap inline-block shrink-0">
              ...
              {pendaftar.pembayaran.length === 0 ? (
                ...
                <div className="space-y-4">
                  {pendaftar.pembayaran.map((payment) => (
                    <div
                      key={payment.id}
                      className="p-4 bg-amber-50/50 rounded-xl border border-amber-100 shadow-xs"
                    >
                        ...
                        <div className="flex flex-col items-end gap-2">
                          ...
                          {(!payment.bukti_transfer_path || payment.status_pembayaran !== "verified") && (
                            <button
                              ...
                              className="px-3 py-1 bg-white hover:bg-amber-100 text-amber-700 rounded-xl text-[10px] font-black uppercase tracking-wider transition-all flex items-center gap-1.5 border border-amber-200 disabled:opacity-50 whitespace-nowrap inline-block shrink-0"
                            >
          ...
          {pendaftar.orang_tua && (
            <div className="bg-white rounded-xl shadow-lg shadow-emerald-900/20 p-6 border border-amber-100">
              <div className="flex items-center gap-3 mb-6">
                <div className="p-3 bg-amber-100 rounded-xl whitespace-nowrap inline-block shrink-0">
        ...
        <div className="space-y-6">
          ...
          {!isKeuangan && !isBerkas && !isPenguji && (
            <div className="bg-white rounded-xl shadow-lg p-6 border-2 border-primary-100">
              <div className="flex items-center gap-3 mb-4">
                <div className="p-2 bg-emerald-100 rounded-xl whitespace-nowrap inline-block shrink-0">
