                  ...
                  {currentPath && (
                    <>
                      ...
                      <button
                        ...
                        disabled={isLoading}
                        className="p-1.5 text-rose-500 hover:bg-rose-100 rounded-xl transition-colors disabled:opacity-40 whitespace-nowrap inline-block shrink-0"
                        title="Hapus berkas"
                      >
                        {isDeleting ? (
      ...
      {current ? (
        ...
        >
          ...
          <button
            ...
            className="w-full mt-2 bg-rose-50 hover:bg-rose-100 text-rose-600 border border-rose-200 py-2.5 rounded-xl text-xs font-bold transition-colors flex items-center justify-center gap-2 whitespace-nowrap inline-block shrink-0"
          >
          ...
          <div className="grid grid-cols-1 md:grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="bg-white p-4 rounded-xl border border-stone-200 shadow-sm space-y-4">
              ...
              <div className="space-y-2">
                ...
                <label className="flex items-center gap-2 p-2 rounded-xl border border-stone-100 cursor-pointer hover:bg-emerald-50 transition-colors">
