    ...
    <div className="space-y-8">
      ...
      <div className="bg-linear-to-br from-primary-600 to-primary-900 rounded-3xl p-5 md:p-8 text-white relative overflow-hidden shadow-xl shadow-primary-900/20">
        ...
        <div className="flex items-center gap-6 relative z-10">
          <div className="w-16 h-16 bg-white/20 backdrop-blur-md rounded-3xl flex items-center justify-center text-secondary-300 shadow-inner">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-1 sm:grid-cols-2 gap-8">
        {/* Provinsi */}
        <div className="bg-white rounded-3xl p-6 shadow-xl shadow-emerald-900/20 border border-ink-100">
