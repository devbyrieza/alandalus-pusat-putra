    ...
    const result = await prisma.$transaction([
      prisma.jadwalUjian.upsert({
        ...
        update: {
          ...
          tempat_santri: examSession.location || "Pesantren Islam Internasional Al-Andalus Putra",
          waktu_mulai_ortu: examSession.start_time,
          waktu_selesai_ortu: examSession.end_time,
          tempat_ortu: examSession.location || "Pesantren Islam Internasional Al-Andalus Putra",
        },
        create: {
          pendaftar_id,
          tahun_ajaran_id,
    ...
    try {
      ...
      if (pendaftar?.no_hp) {
        ...
        await notifyTestSchedule({
          ...
          tempat: examSession.location || "Pesantren Islam Internasional Al-Andalus Putra",
        });
      }
    } catch (waError) {
