      ...
      <div className="grid grid-cols-1 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <div className="glass-panel p-5 md:p-8 rounded-[2rem] shadow-sm border border-secondary-200 app-card relative overflow-hidden">
            ...
            {isPaymentPending && (
              <div className="mt-8 p-5 bg-emerald-50 border border-emerald-200 rounded-xl flex flex-col sm:flex-row items-center sm:items-start gap-4">
                <div className="w-12 h-12 bg-emerald-100 rounded-xl flex items-center justify-center shrink-0 whitespace-nowrap inline-block shrink-0">
