...
export default function RekapFeePengujiPage() {
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto pb-10">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-white p-6 rounded-3xl border border-ink-100 shadow-xl shadow-emerald-900/20">
        ...
        <div className="flex items-center gap-3 w-full md:w-auto">
          <Button
            onClick={fetchData}
            variant="outline"
            className="rounded-3xl border-ink-200 text-ink-600 font-bold hover:bg-ink-50 h-11"
          >
          ...
          <Button
            ...
            className="rounded-3xl bg-emerald-600 hover:bg-emerald-700 text-white font-black shadow-lg shadow-emerald-600/20 h-11"
          >
        ...
        <div className="p-6 border-b border-ink-100 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="relative w-full md:max-w-md">
            ...
            <input
              ...
              className="w-full bg-ink-50 border border-ink-100 rounded-3xl pl-11 pr-4 py-3 text-sm font-bold text-ink-900 focus:ring-2 focus:ring-primary-600/10 outline-none"
            />
          </div>
