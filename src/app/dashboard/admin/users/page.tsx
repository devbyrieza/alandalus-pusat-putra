                  ...
                  >
                    <td className="p-5 md:p-8">
                      <div className="flex items-center gap-5">
                        <div className="w-12 h-12 rounded-xl bg-primary-100 flex items-center justify-center text-primary-700 font-black text-xs border-2 border-white shadow-lg shadow-emerald-900/20 whitespace-nowrap shrink-0">
