                        ...
                        <div className="flex items-center gap-4">
                          ...
                          {!ta.is_active && (
                            <button
                              ...
                              className="p-2 bg-white text-stone-400 hover:text-purple-600 rounded-xl transition-colors border border-stone-200"
                            >
                              <Edit3 className="w-5 h-5" />
                            </button>
                          )}
            ...
            <form onSubmit={handleUpdate} className="p-6 space-y-4">
              ...
              <div className="pt-4 flex gap-3">
                ...
                <button
                  type="submit"
                  disabled={updating}
                  className="flex-1 px-6 py-3 bg-purple-600 hover:bg-purple-700 text-white font-bold rounded-xl shadow-lg shadow-purple-200 transition-all disabled:opacity-50 flex items-center justify-center gap-2"
                >
