...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen bg-[#064e3b] bg-gradient-to-br from-[#042f26] via-[#064e3b] to-[#065f46] flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-full max-w-[600px] h-[600px] bg-amber-400/15 rounded-full blur-[120px] -translate-y-1/3 translate-x-1/3 pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-full max-w-[500px] h-[500px] bg-emerald-300/10 rounded-full blur-[100px] -translate-x-1/3 translate-y-1/3 pointer-events-none" />
        ...
        >
          ...
          {!roleSelectionData && (
            <div className="bg-slate-100 p-2 rounded-[2rem] flex relative mb-12 border border-slate-200">
              ...
              <motion.div
                ...
                className={`absolute top-2 bottom-2 rounded-3xl bg-white shadow-xl shadow-emerald-900/20 border border-slate-200/50 ${
                  activeTab === "pendaftar"
              ...
              <button
                ...
                className={`flex-1 relative z-10 py-3.5 text-xs font-black uppercase tracking-widest text-center rounded-3xl transition-colors duration-300 ${activeTab === "pendaftar" ? "text-primary-700" : "text-ink-600 hover:text-ink-800"}`}
              >
                Pendaftar
              </button>
              <button
                ...
                className={`flex-1 relative z-10 py-3.5 text-xs font-black uppercase tracking-widest text-center rounded-3xl transition-colors duration-300 ${activeTab === "admin" ? "text-primary-700" : "text-ink-600 hover:text-ink-800"}`}
              >
                Portal Staf
              </button>
            </div>
          ...
          <AnimatePresence mode="wait">
            {error && (
              ...
              >
                <div className="w-10 h-10 bg-red-500 rounded-3xl flex items-center justify-center text-white shrink-0 shadow-premium-xs">
              ...
              {roleSelectionData ? (
                ...
                >
                  <div className="text-center mb-6">
                    <div className="w-14 h-14 bg-secondary-100 rounded-3xl flex items-center justify-center mx-auto mb-4 border border-secondary-200">
                    ...
                    {roleSelectionData.available_roles.map((role) => {
                      ...
                      return (
                        <motion.button
                          ...
                          className={`w-full p-4 rounded-3xl bg-linear-to-r ${info.color} border text-left flex items-center gap-4 transition-all hover:shadow-md disabled:opacity-60`}
                        >
                          <div className="w-10 h-10 rounded-3xl bg-white/80 flex items-center justify-center text-primary-700 font-bold shadow-xl shadow-emerald-900/20 shrink-0">
                ...
                >
                  ...
                  <div className="text-center pt-4">
                    ...
                    <Link
                      href="/ppdb"
                      className="inline-flex items-center gap-2 px-6 md:px-10 py-3 rounded-3xl bg-white/50 backdrop-blur-sm text-primary-800 font-black text-sm border border-primary-100 hover:bg-white hover:shadow-md hover:-translate-y-1 transition-all"
                    >
                      Daftar Baru Di Sini
                    </Link>
                  </div>
                ...
                >
                  ...
                  >
                    <input
                      ...
                      placeholder="••••••••"
                      className="w-full px-5 py-3 md:px-8 md:py-5 pl-14 md:pl-16 pr-12 md:pr-16 rounded-3xl md:rounded-3xl bg-white/50 backdrop-blur-sm border border-white/50 focus:bg-white/90 focus:border-secondary-400 focus:ring-4 focus:ring-secondary-100 transition-all font-bold text-ink-950 placeholder:font-medium placeholder:text-ink-400 text-sm md:text-base shadow-inner"
                      disabled={isLoading}
                    />
                  </AuthInput>
