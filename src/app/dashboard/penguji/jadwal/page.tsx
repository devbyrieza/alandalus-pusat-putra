                ...
                {!isSelectMode ? (
                  <>
                    ...
                    <button
                      ...
                      className="w-full sm:w-auto flex items-center justify-center gap-3 px-6 py-4 bg-primary-50 hover:bg-primary-100 text-primary-700 rounded-xl font-black border border-primary-100 transition-all text-xs uppercase tracking-widest active:scale-95 shadow-lg shadow-emerald-900/20 whitespace-nowrap shrink-0"
                    >
            ...
            <form onSubmit={handleCreateSlot} className="p-5 md:p-8 space-y-6 overflow-y-auto overscroll-contain custom-scrollbar flex-1">
              ...
              <div className="space-y-3">
                ...
                <div className="bg-emerald-50 rounded-xl p-4 border border-emerald-100 flex items-start gap-3">
                  <div className="w-8 h-8 bg-emerald-100 rounded-xl flex items-center justify-center shrink-0 text-emerald-600 whitespace-nowrap shrink-0">
