  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="relative bg-gradient-to-br from-primary-800 via-primary-900 to-primary-950 p-6 md:p-8 rounded-xl overflow-hidden text-white shadow-lg">
        ...
        <div className="absolute top-4 right-4 w-16 h-16 bg-amber-400/20 rounded-xl rotate-12" />

        <div className="relative z-10">
          <div className="inline-flex items-center gap-2 bg-white/10  border border-white/20 px-3 py-1.5 rounded-full text-xs font-black mb-4 text-amber-300">
          ...
          <h1 className="text-2xl md:text-3xl font-black leading-tight mb-2 text-white drop-shadow-md">
            <span className="flex items-center gap-3">
              <PartyPopper className="w-8 h-8 md:w-10 md:h-10 text-amber-400 drop-shadow-lg shadow-emerald-900/20" />
      ...
      {/* ─── INFO PENGINAPAN ─── */}
      <div className="bg-blue-50 border border-blue-200 rounded-xl p-5 md:p-6 shadow-lg shadow-emerald-900/20">
      ...
      <div className="grid grid-cols-1 gap-4">
        <a
          ...
          className="flex items-center gap-3 bg-white hover:bg-emerald-50 rounded-xl p-4 border border-ink-100 hover:border-emerald-200 transition-all shadow-lg shadow-emerald-900/20 group"
        >
          <div className="w-10 h-10 rounded-xl bg-emerald-100 text-emerald-600 flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform whitespace-nowrap inline-block shrink-0">
      ...
      {!seragamStatus.sudahIsi && (
        <div className="flex items-start gap-3 bg-orange-50 border border-orange-300 rounded-xl px-4 py-4 shadow-lg shadow-emerald-900/20">
          <div className="w-9 h-9 rounded-xl bg-orange-500 flex items-center justify-center flex-shrink-0 shadow-lg shadow-emerald-900/20 mt-0.5">
          ...
          <Link
            ...
            className="flex-shrink-0 flex items-center gap-1.5 bg-orange-500 hover:bg-orange-600 text-white text-xs font-black px-3 py-2 rounded-xl transition-colors shadow-lg shadow-emerald-900/20 whitespace-nowrap"
          >
      ...
      <div className="bg-white rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-ink-100/50 overflow-hidden relative">
        ...
        <div className="px-6 py-5 border-b border-ink-100/50 bg-gradient-to-r from-primary-50/50 to-transparent flex items-center gap-4 relative">
          <div className="w-12 h-12 bg-white rounded-xl flex items-center justify-center shadow-lg shadow-emerald-900/20 border border-primary-100">
          ...
          {!isEditing && (
            <div className="ml-auto hidden sm:flex items-center gap-2 bg-gradient-to-r from-emerald-50 to-emerald-100 text-emerald-700 text-xs font-black px-4 py-2 rounded-xl border border-emerald-200/50 shadow-lg shadow-emerald-900/20">
        ...
        {isEditing ? (
          <div className="p-6 relative">
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200/60 rounded-xl px-5 py-4 mb-8 flex items-start gap-3 shadow-lg shadow-emerald-900/20">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {formData.statusKehadiran === "HADIR" && (
                <>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="relative">
                      <select
                        ...
                        className="w-full bg-white border-2 border-ink-200 px-5 py-4 rounded-xl focus:ring-4 focus:ring-primary-500/10 focus:border-primary-400 outline-none font-bold text-ink-900 text-sm appearance-none transition-all shadow-lg shadow-emerald-900/20"
                        required
                      >
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-3">
                      <button
                        ...
                        className="w-14 h-14 rounded-xl bg-white border-2 border-ink-200 hover:border-primary-300 hover:bg-primary-50 text-ink-700 font-black text-2xl flex items-center justify-center transition-all shadow-lg shadow-emerald-900/20 active:scale-95"
                      >
                        −
                      </button>
                      <div className="flex-1 relative">
                        <input
                          ...
                          className="w-full bg-white border-2 border-ink-200 px-5 py-4 rounded-xl focus:ring-4 focus:ring-primary-500/10 focus:border-primary-400 outline-none font-black text-center text-ink-900 text-xl shadow-lg shadow-emerald-900/20 transition-all"
                          required
                        />
                  ...
                  <div className="space-y-3 pt-3">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-1 gap-4">
                      {/* Mobil */}
                      <div className="bg-white border-2 border-ink-200 rounded-xl p-5 relative flex items-center justify-between shadow-lg shadow-emerald-900/20 hover:border-primary-300 transition-colors">
                        <div>
                        ...
                        <div className="flex items-center gap-2 bg-ink-50 rounded-xl p-1 border border-ink-100">
                          <button
                            ...
                            className="w-8 h-8 rounded-xl bg-white shadow-lg shadow-emerald-900/20 hover:bg-ink-100 text-ink-700 font-black flex items-center justify-center transition-all active:scale-95"
                          >
                            −
                          </button>
                          <input
              ...
              <div className="space-y-3 pt-3">
                ...
                <textarea
                  ...
                  className="w-full bg-white border-2 border-ink-200 px-5 py-4 rounded-xl focus:ring-4 focus:ring-primary-500/10 focus:border-primary-400 outline-none font-medium text-sm min-h-[120px] resize-none shadow-lg shadow-emerald-900/20 transition-all"
                />
              </div>
          ...
          <div className="p-6 space-y-5">
            ...
            {formData.statusKehadiran === "HADIR" && formData.jumlahMobil === 0 && formData.jumlahMotor === 0 && (
              <div className="bg-gradient-to-br from-orange-500 to-amber-500 text-white p-5 rounded-xl shadow-lg shadow-orange-500/25 flex flex-col md:flex-row items-center md:items-start justify-between gap-4 mt-6">
                ...
                <button
                  ...
                  className="flex-shrink-0 flex items-center justify-center gap-2 bg-white text-orange-600 hover:bg-orange-50 font-black px-5 py-3 rounded-xl transition-all shadow-lg shadow-emerald-900/20 w-full md:w-auto hover:scale-105 active:scale-95"
                >
            ...
            <div className="flex justify-end pt-6">
              <button
                onClick={() => setIsEditing(true)}
                className="flex items-center gap-2 bg-white hover:bg-primary-50 text-primary-700 border-2 border-primary-200 hover:border-primary-300 font-black px-6 py-3 rounded-xl transition-all shadow-lg shadow-emerald-900/20 cursor-pointer text-sm"
              >
                <Edit className="w-4 h-4" />
      ...
      <div className="bg-white rounded-xl border border-ink-100 shadow-lg shadow-emerald-900/20 overflow-hidden mb-6">
        <div className="px-6 py-4 border-b border-emerald-100 bg-emerald-50 flex items-center gap-3">
          <div className="w-9 h-9 bg-emerald-100 rounded-xl flex items-center justify-center whitespace-nowrap inline-block shrink-0">
        ...
        <div className="p-5 space-y-6">
          ...
          <div>
            <div className="flex items-center gap-2 mb-3">
              <div className="w-6 h-6 rounded-full bg-emerald-100 text-emerald-700 flex items-center justify-center font-black text-xs shadow-lg shadow-emerald-900/20 whitespace-nowrap inline-block shrink-0">
                1
              </div>
              <h3 className="font-black text-ink-900 text-sm">Alur Kedatangan</h3>
            </div>
            <div 
              className="relative w-full aspect-[1/1.4] bg-ink-50 rounded-xl border border-ink-100 overflow-hidden cursor-zoom-in group shadow-lg shadow-emerald-900/20"
      ...
      {/* ─── JADWAL ACARA ─── */}
      <div className="bg-white rounded-xl border border-ink-100 shadow-lg shadow-emerald-900/20 overflow-hidden">
              ...
              <div key={idx} className="flex gap-4 items-start group">
                ...
                <div className="flex-1 pb-4">
                  <div className="flex items-start gap-3">
                    <div className="w-10 h-10 rounded-xl bg-white border border-primary-100 flex items-center justify-center flex-shrink-0 shadow-lg shadow-emerald-900/20 text-primary-600">
      ...
      {/* ─── BERKAS PERSYARATAN ─── */}
      <div className="bg-white rounded-xl border border-ink-100 shadow-lg shadow-emerald-900/20 overflow-hidden mt-6">
