...
const FeatureCard = ({
  ...
  >
    ...
    <div className="flex flex-col justify-center">
      <div
        className={`w-16 h-16 ${item.bgColor} rounded-3xl flex items-center justify-center shadow-xl shadow-emerald-900/20 mb-8 transition-transform hover:scale-110`}
      >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-10">
        {item.stats.map((stat, statIdx) => (
          <div
            key={statIdx}
            className="bg-primary-50 p-4 rounded-[1.5rem] border border-primary-100 text-center hover:bg-white hover:shadow-xl shadow-emerald-900/20 transition-all"
          >
      ...
      {/* Results List */}
      <div className="app-card bg-white p-5 md:p-8 rounded-[2.5rem] border border-primary-100 shadow-xl shadow-emerald-900/20 mb-8">
...
const StatsCard = ({ icon: Icon, value, label, sublabel }: HeroStat) => (
  <motion.div
    whileHover={{ y: -5 }}
    className="app-card bg-white p-4 md:p-6 rounded-[2rem] md:rounded-[2.5rem] border border-primary-100 shadow-xl shadow-emerald-900/20 text-center min-w-[140px] md:min-w-[160px] flex flex-col items-center"
  >
    <div className="w-10 h-10 md:w-12 md:h-12 rounded-3xl md:rounded-3xl bg-primary-50 flex items-center justify-center text-primary-600 mb-3 md:mb-4 border border-primary-100">
...
const ScheduleCard = ({
  ...
  <motion.div
    ...
    className={`group p-10 rounded-[3rem] ${schedule.bgColor} border border-primary-100 shadow-xl shadow-emerald-900/20 hover:shadow-md transition-all duration-500 hover:-translate-y-2`}
  >
    <div className="flex flex-col h-full">
      <div className="flex items-center justify-between mb-8">
        <div className="w-16 h-16 bg-white rounded-3xl flex items-center justify-center shadow-xl shadow-emerald-900/20 group-hover:scale-110 transition-transform border border-primary-100">
      ...
      <div className="mt-auto inline-flex items-center gap-3 bg-white/60 p-4 rounded-3xl border border-primary-100 shadow-xl shadow-emerald-900/20">
...
const WeeklyActivityCard = ({
  ...
  <motion.div
    ...
    className={`app-card group p-8 rounded-[2.5rem] bg-white border border-primary-50 shadow-xl shadow-emerald-900/20 hover:shadow-md transition-all hover:-translate-y-2 text-center`}
  >
    <div
      className={`w-14 h-14 ${activity.bg} rounded-3xl flex items-center justify-center ${activity.color} mx-auto mb-6 group-hover:scale-110 transition-transform border border-primary-100`}
    >
...
const EkskulCard = ({
  ...
  <motion.div
    ...
    viewport={{ once: true }}
    transition={{ delay: index * 0.05 }}
    className="app-card group px-7 py-6 md:p-8 rounded-[2rem] md:rounded-[2.5rem] bg-white border border-primary-50 shadow-xl shadow-emerald-900/20 hover:shadow-md hover:border-primary-200 transition-all hover:-translate-y-2 text-center h-full flex flex-col justify-between"
  >
    <div className="w-12 h-12 md:w-16 md:h-16 bg-primary-50 rounded-3xl md:rounded-3xl flex items-center justify-center text-primary-600 mx-auto mb-4 md:mb-6 group-hover:scale-110 transition-all duration-300 border border-primary-100">
  ...
  return (
    <main className="bg-white min-h-screen">
      ...
      <section className="relative py-24 md:py-32 overflow-hidden bg-white">
        <div className="absolute top-0 right-0 w-full max-w-[600px] h-[600px] bg-amber-50/50 rounded-full blur-[120px] -translate-y-1/2 translate-x-1/2 pointer-events-none" />
        ...
        <Container className="relative z-10 text-center">
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-1.5 rounded-pill bg-primary-50 border border-primary-100 text-primary-700 text-xs font-bold uppercase tracking-widest mb-10 shadow-xl shadow-emerald-900/20"
          >
      ...
      <section className="py-24 relative bg-surface-50/30">
        <Container>
          ...
          >
            <div className="absolute top-0 right-0 w-[300px] h-[300px] md:w-full max-w-[500px] md:h-[500px] bg-amber-50/50 rounded-full blur-[100px] translate-x-1/3 -translate-y-1/3 pointer-events-none" />
            ...
            <div className="relative z-10 grid grid-cols-1 md:grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6 w-full">
              {[
                ...
                >
                  <div className="w-12 h-12 md:w-14 md:h-14 rounded-3xl bg-primary-50 shadow-xl shadow-emerald-900/20 flex items-center justify-center text-primary-600 shrink-0 group-hover:bg-primary-600 group-hover:text-white transition-colors border border-primary-100">
