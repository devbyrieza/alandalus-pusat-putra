...
export default function KepribadianTestPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 md:p-6 pb-32">
      ...
      {/* Progress */}
      <div className="bg-white rounded-xl border p-4 mb-6 shadow-lg shadow-emerald-900/20 mt-6">
        ...
        <div className="w-full h-2 bg-stone-100 rounded-full overflow-hidden">
          <div
            className="h-full bg-linear-to-r from-primary-500 to-primary-700 rounded-full transition-all duration-500 shadow-lg shadow-emerald-900/20 shadow-primary-200"
            style={{
      ...
      <div className="space-y-4 mb-6">
        {currentQuestions.map((q) => (
          <div key={q.id} className="bg-white p-5 rounded-xl border shadow-lg shadow-emerald-900/20">
